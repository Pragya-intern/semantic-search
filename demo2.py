...
if __name__ == '__main__':
    ...
    * Generating tags from images, and searching for images using language
    ...
    sample_images = [to_array(image_paths[1 + i * 50]) for i in range(3)]
    captions = [all_labels[1 + i * 50] for i in range(3)]
    ...
    #changes
    images_features=vector_search.generate_features(image_paths, model)
